...
const contactus = () => {
    ...
    const success = 'Your contact request has been sent to the admin';
            ...
            >
                ...
                >
                    ...
                    <div className="desc" style={{ fontSize: '16px' }}>
                        ...
                        <br /> with your inquiry or find the department email you would
                        ...
                        Contact us at:
                        <br />
                        <a href={`tel:+1340-626-9224`}>(340)626-9224</a>
                        <br /> <a href={`tel:+1954-390-1560`}>(954)390-1560</a>
                        <br />
                        <br />
                        Email us at:
                        <br />
                        <a href={`mailto:agilecarrental@gmail.com`}>@agilecarrental</a>
                    </div>
                </div>
